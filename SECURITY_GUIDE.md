...
## Plan de RÈponse aux Incidents

1. **DÈtection** : Alertes automatisÈes
2. **Containment** : Isolation du systËme affectÈ
3. **…radication** : Suppression de la menace
4. **Restauration** : Retour ‡ la normale
5. **AmÈlioration** : Revue post-incident
...
Toutes les opÈrations sensibles sont logged :
- CrÈation/Modification/Suppression
- Authentification
- Changements de rÙle
- AccËs aux donnÈes sensibles

Les logs d'audit sont conservÈs 7 ans.
